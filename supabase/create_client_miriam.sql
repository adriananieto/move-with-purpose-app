-- Pre-provisions Miriam Navarro Rodriguez's login (Premium tier — confirm with Adriana).
-- EDIT the email below, then run this whole script in the Supabase SQL editor.
--
...
insert into _new_client_params values (
  'mimanavarro@gmail.com',
  'Miriam Navarro Rodriguez',
  'Premium'
);
