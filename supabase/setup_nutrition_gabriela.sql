-- Gabriela De Jesus Alvarado's nutrition plan — exact same plan as Karen
-- J Rodriguez Navarro, per Adriana's instruction.
-- Run create_client_gabriela.sql FIRST.
--
...
delete from public.meal_options where user_id = (select client_id from _gabriela);
