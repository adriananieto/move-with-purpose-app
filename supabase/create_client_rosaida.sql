-- Pre-provisions Rosaida Ortiz Casablanca's login (Premium tier — confirm with Adriana).
-- Run this whole script in the Supabase SQL editor, THEN run supabase/seed_rosaida.sql
-- right after — it already looks her up by name and will attach her existing 5-day plan.
--
...
insert into _new_client_params values (
  'rosaidaortiz@gmail.com',
  'Rosaida Ortiz Casablanca',
  'Premium'
);
