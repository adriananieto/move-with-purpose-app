-- Karen J Rodriguez Navarro's nutrition plan, from
-- "MOVE WITH PURPOSE - KAREN (14septiembre).pdf".
-- Run create_client_karen.sql FIRST.
--
...
delete from public.meal_options where user_id = (select client_id from _karen);
